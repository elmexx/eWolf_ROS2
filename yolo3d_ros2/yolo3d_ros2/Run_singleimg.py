...
def main():
    ...
    img_path = '/home/fmon005/Documents/GKU/Stereo-RCNN-1.0/data/kitti/testing/image_2'#'./docs/image/'
    ...
    for filename in os.listdir(img_path):
        ...
        testP = np.zeros((3, 4))
        testP[0:3, 0:3] = proj_matrix[0:3,0:3] #camera_info[0:3,0:3]
        ...
        for box, cl in zip(boxes, clss):
            ...
            # TODO: better check
            try:
                detectedObject = DetectedObject(img, cls_name, box_2d, testP)
            except:
