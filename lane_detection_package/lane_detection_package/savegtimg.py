...
if __name__ == "__main__":
    ...
    model_path = './model/Lanenet3103_mixdata.pth'
    # CarlaCP_epoch20.pth
    # old_CP_epoch14.pth
    ...
    while(cap.isOpened()):
        ...
        if ret==True:
            ...
            #out_mask_img = drawsinglelane(mask_img_right, birdseyeviewimage, unwarp_matrix, ego_left_lane)
            out_mask_img = cv2.add(mask_img_right,mask_img_left)
            ...
            if ii%10000==0:
                ...
                if user_input:
                    cv2.imwrite('/home/fmon005/Documents/GKU/001_Data/Campus/gt_image/{}.png'.format(f_n),frame)
                    cv2.imwrite('/home/fmon005/Documents/GKU/001_Data/Campus/gt_binary/{}.png'.format(f_n),out_mask_img)
                    print('save image')
                    continue
