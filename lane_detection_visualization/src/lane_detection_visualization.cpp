...
public:
        ...
        : Node("lane_detection_visualization")
    {
        ...
        sub_markings = create_subscription<lane_parameter_msg::msg::LaneMarkingProjectedArrayBoth>("/lane_markings_left_right_projected", 10, std::bind(&lane_detection_visualization::laneMarkingCallback, this, _1));
        
    }

    void laneMarkingCallback(lane_parameter_msg::msg::LaneMarkingProjectedArrayBoth::SharedPtr msg)
    {
        ...
        for (size_t i = 0; i < msg->markings_left.size(); i++)
        {
        ...
        for (size_t i = 0; i < msg->markings_right.size(); i++)
        {
            geometry_msgs::msg::Point point;
...
private:
    ...
    std::shared_ptr<rclcpp::Subscription<lane_parameter_msg::msg::LaneMarkingProjectedArrayBoth>> sub_markings;
};
