...
```
python tools/detect.py configs/condlane/resnet101_culane.py --img Campus.png --load_from condlane_r101_culane.pth --show
```

To run inference on example video and show the visualization video:
```
python tools/detect_video.py configs/condlane/resnet101_culane.py --video output.avi --load_from model/condlane_r101_culane.pth --show
```
