...
try:
    ctypes.cdll.LoadLibrary(os.getenv("HOME")+ '/ros2_ws/src/yolo_trt_ros2/yolo_trt_ros2/plugins/libyolo_layer.so')
except OSError as e:
...
class TrtYOLO(object):
    ...
    def _load_engine(self):
        ...
        TRTbin = os.path.join(os.getenv("HOME"), 'ros2_ws/src/yolo_trt_ros2/yolo_trt_ros2/yolo/%s.trt' % self.model)
